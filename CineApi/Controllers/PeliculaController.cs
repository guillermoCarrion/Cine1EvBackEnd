...
public class PeliculaController : ControllerBase
{
    ...
    {
        Peliculas.Add(new Pelicula(nombre: "Reservoir Dogs", id: 1, director: "Quentin Tarantino", sinopsis: "Seis criminales profesionales son contratados para robar en un almacén de diamantes, pero la policía aparece inesperadamente en el momento del atraco. Algunos miembros de la banda mueren en el enfrentamiento y otros logran huir.", imagen: "https://i.pinimg.com/736x/6c/0d/da/6c0ddab00848d4ecdf6d5afbf64be0b8.jpg", idsala : 1)
        {
            sesiones = GenerarSesiones(1, DateTime.Parse("14:00"), DateTime.Parse("18:00"), 6, 8)
        });

        Peliculas.Add(new Pelicula(nombre: "Star Wars", id: 2, director: "George Lucas", sinopsis: "La nave en la que viaja la princesa Leia es capturada por las tropas imperiales al mando del temible Darth Vader. Antes de ser atrapada, Leia consigue introducir un mensaje en su robot R2-D2, quien acompañado de su inseparable C-3PO logran escapar.", imagen: "https://i.pinimg.com/736x/d2/79/3c/d2793c0519e160fa3bd9a223b212f923.jpg", idsala : 2)
        {
            sesiones = GenerarSesiones(2, DateTime.Parse("14:00"), DateTime.Parse("18:00"), 6, 8)
        });
        ...
        {
            sesiones = GenerarSesiones(3, DateTime.Parse("14:00"), DateTime.Parse("18:00"), 6, 8)
        });
        ...
        {
            sesiones = GenerarSesiones(4, DateTime.Parse("14:00"), DateTime.Parse("18:00"), 6, 8)
        });
        ...
        {
            sesiones = GenerarSesiones(5, DateTime.Parse("14:00"), DateTime.Parse("18:00"), 6, 8)
        });

        Peliculas.Add(new Pelicula(nombre: "Enter the Void", id: 6, director: "Gaspar Noé", sinopsis: "Óscar (Nathaniel Brown) vive en Tokio con su hermana, Linda (Paz de la Huerta), y se sustenta a sí mismo vendiendo drogas, contra el consejo de su amigo, Alex (Cyril Roy). Alex intenta reubicar el interés de Óscar en el Libro tibetano de los muertos, un libro budista sobre la vida después de la muerte.", imagen:"https://i.pinimg.com/736x/c4/a1/a5/c4a1a516a08e7be519e61a41ff533c46.jpg" ,idsala : 6)
        {
            sesiones = GenerarSesiones(6, DateTime.Parse("14:00"), DateTime.Parse("18:00"), 6, 8)
        });
    }


    private static List<Sesion> GenerarSesiones(int idsala, DateTime hora1, DateTime hora2, int filas, int columnas)
    {
